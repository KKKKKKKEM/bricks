...
`bricks.frameworks.crawler.downloaders` 提供两个结构化协议：
...
from bricks.frameworks.crawler import DownloadNode, Request
...
`bricks.frameworks.crawler.downloaders.httpx` 提供 HttpxDownloader 和 AsyncHttpxDownloader：
